-- Corrigir check_and_update_user_goal para contar apenas 'divulgacao' como post
...
BEGIN
  ...
  -- Contar APENAS divulgacao como posts e sales aprovadas do usuário para este evento
  SELECT 
    COUNT(*) FILTER (WHERE s.submission_type = 'divulgacao' AND s.status = 'approved'),
